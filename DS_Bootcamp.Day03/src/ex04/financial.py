...
def get_response():
  ...
  response = requests.get(f'https://finance.yahoo.com/quote/{sys.argv[1].upper()}/financials/', cookies=cookies, headers=headers)
...
if __name__ == '__main__':
  ...
  with open('profiling_tottime.txt', 'w') as f:
    f.write(s.getvalue())